...
public class weapons {
  ...
  public weapons(){
    ...
    public static void initializeContentWeapons() {
      ...
      Weapon messerschmidter = new Weapon("The Messerschmidter", 5, "Sword", 40, new Buff("attack"), new Verbs("with his Messerschmidter tapped", "with his Messerschmidter spat on"), "A life size version of Brayden Messerschmidt but as a sword"); //benji weapon
